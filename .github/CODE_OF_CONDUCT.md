...
- Being patient and constructive when giving feedback
...
They have the right and responsibility to remove, edit, or reject comments, commits, code, issues,
...
This Code of Conduct applies within all project spaces, including issues, pull requests, discussions,
and other communication channels. It also applies when an individual is representing the project
...
1. **Correction** – A private or public clarification of behavior.
2. **Warning** – A formal warning for inappropriate behavior.
